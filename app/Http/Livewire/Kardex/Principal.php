...
class Principal extends Component
{
    ...
    public $permiso_listar = 'd-none', $empresas_id;
    ...
    public function mount()
    {
        ...
        if (!Util::getExisteTiendaSeleccionadaLocalStorage()) {
          ...
          if (!Util::tienePermiso(Util::$OPCION_KARDEX)) {
            return redirect()->route('dashboard');
        }
    }
    ...
    {
        return view('livewire.kardex.principal', ['data' => $this->modelarDatos()]);
    }
    ...
    public function destruir()
    {
        ...
        Articulo::destroy($this->selectedPersonales);
