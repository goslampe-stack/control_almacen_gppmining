! function(t, e) { "object" == typeof exports && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define(e) : (t = t || self).Sweetalert2 = e() }(this, function() {
    ...
    function ot(t, e, n) { n === "".concat(parseInt(n)) && (n = parseInt(n)), n || 0 === parseInt(n) ? t.style[e] = "number" == typeof n ? "".concat(n, "px") : n : t.style.removeProperty(e) }
    ...
    function pn(t) { var e = { popup: x(), container: C(), content: P(), actions: q(), confirmButton: T(), denyButton: L(), cancelButton: I(), loader: D(), closeButton: H(), validationMessage: S(), progressSteps: O() }; return St.domCache.set(t, e), e }
    ...
    var bn, wn = function(t) { for (var e in t) t[e] = new WeakMap },
        Q = Object.freeze({
            ...
            closeModal: we,
            closeToast: we,
            enableButtons: function() { Pe(this, ["confirmButton", "denyButton", "cancelButton"], !1) },
            disableButtons: function() { Pe(this, ["confirmButton", "denyButton", "cancelButton"], !0) },
    ...
    c(Cn.prototype, Q), c(Cn, ce), Object.keys(Q).forEach(function(t) { Cn[t] = function() { if (bn) return bn[t].apply(bn, arguments) } }), Cn.DismissReason = Z, Cn.version = "10.10.2";
    var kn = Cn;
