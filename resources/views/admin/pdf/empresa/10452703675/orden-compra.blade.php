                ...
                <div class="orden">
                    <table width="100%" style="table-layout: fixed;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                   <p> <b>N° de orden:</b> {{$orden->numero_orden_compra}}</p>
                                </td>
                                <td >
                                  <p> <b>Forma de pago:</b> Cr&eacute;dito</p>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                   <p> <b>N° de solicitud:</b> {{$orden->solicitudCotizacion->numero_solicitud_cotizacion}}</p>
                                </td>
                                <td>
                                    <p> <b>Vigencia:</b> 3 d&iacute;as</p>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                   <p> <b>N° de cotizaci&oacute;n:</b> {{$orden->solicitudCotizacion->numero_cotizacion}}</p>
                                </td>
                              
                            </tr>
                            <tr>
                                <td colspan="2">
                                   <p> <b>Fecha:</b> {{ \Carbon\Carbon::parse($orden->fecha_pedido)->format('d/m/Y') }} </p>
                                </td>
            ...
            <div class="pie-pagina">
                ...
                <table width="100%">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <p style="margin-top: 15px; white-space: pre-line;">Nota: {{$orden->descripcion_solicitamos}}                                                                    
                                    </p>
