                ...
                <div class="orden">
                    <table width="100%" style="table-layout: fixed;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <br>
                                                    ...
                                                    <span>
                                                        <b> Domicio Fiscal: </b>{{$solicitud->proveedor->direccion}}
                                ...
                                <td width="30%">
                                                   ...
                                                   <span>
                                                    ...
                                                    <span>
                                                        <b> <b>Fecha: </b> {{ \Carbon\Carbon::parse($solicitud->fecha_solicitud)->format('d/m/Y') }}
                            ...
                            <tr>
                                <td colspan="2">
                                                                    <p>Se solicita su mejor propuesta comercial respecto a los materiales detallados a continuación, los cuales serán destinados al abastecimiento para trabajos de perforación y mantenimiento preventivo en zona minera:</p>
                ...
                <div class="detalle center-text">
                  ...
                  <table width="100%">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <p style="">{{$solicitud->descripcion_solicitamos}}

                                       <!--  <br>
                                        <span>
                                            <b>Zona productiva: </b>{{$solicitud->descripcion}}
                                        </span> -->
                                    </p>
