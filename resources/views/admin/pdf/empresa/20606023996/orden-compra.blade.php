            ...
            <div class="informacion">
                ...
                <div class="orden">
                    <table width="100%" style="table-layout: fixed;">
                        ...
                        <tbody>
                           <tr>
                                <td colspan="2">
                                    <p style="text-align: center;"> <b>INVERSIONES MINERAS & METALURGICAS 2020 E.I.R.L.</b>
                                <br>
                                20606023996
                                <br>
                                <b>Domicilio Fiscal: </b> Jr. 21 De Setiembre Nro. 533A Otr. P.J. Pampa De Comas– Comas- Lima- Lima
                                <br>
                                <b>Email: </b>inversiones2020.logistica@gmail.com
                                </p>
                                </td>
                            </tr>
                             <tr>
                ...
                <div>
                    <table width="100%">
                        ...
                        <tr>
                                <td > <span><b>PROVEEDOR</b></span><br></td>
                                <td width="30%"> <span><b>ORDEN DE COMPRA</b></span><br></td>
                            ...
                            <tr>
                              ...
                              <td style=" vertical-align: top;">
                                    ...
                                    <span>
                                        <b> Domicilio Fiscal: </b> {{$orden->proveedor->direccion}}
                                ...
                                <td style=" vertical-align: top;">
                                    ...
                                    <span>
                                       <b>N° de orden:</b> {{$orden->numero_orden_compra}}

                                    </span><br>
                                    <span>
                                       <b>N° de solicitud:</b> {{$orden->solicitudCotizacion->numero_solicitud_cotizacion}}

                                    </span><br>
                                    <span>
                                       <b>N° de cotizaci&oacute;n:</b> {{$orden->solicitudCotizacion->numero_cotizacion}}

                                    </span><br>
                                    <span>
                                       <b>Fecha:</b> {{ \Carbon\Carbon::parse($orden->fecha_pedido)->format('d/m/Y') }}
            ...
            <div class="pie-pagina">
                ...
                <table width="100%">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <p style="margin-top: 15px; white-space: pre-line;">{{$orden->descripcion_solicitamos}}                                                                    
                                    </p>
