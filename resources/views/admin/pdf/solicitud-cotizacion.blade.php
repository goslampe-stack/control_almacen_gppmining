        ...
        <header class="main-header">
            <div class="informacion">
                ...
                <div class="descripcion">
                    <p style="margin-top: 15px;">  Solicitamos tenga a bien cotizarnos los productos requeridos lineas abajo, por ser necesario para nuestras operaci&oacute;nes de producci&oacute;n.</p>
                </div>
            </div>
        </header>
