<div class="content-wrapper">
	<section class="content mt-3">
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-12">
					<h4 class="mb-3"><b>Inventario inicial</b></h4>
				</div>
			</div>
							...
							<div class="card apl-border">
								<div class="card-header">
									<div class="row">
										<div class="col-md-6">
											<b>{{$data->count()}}</b><br>
											<font class="apl-text-gray">Categoría productos</font>
										</div>

										<div class="col-md-6">
											<button class="btn btn-primary float-right" style="border-radius: .7rem;" wire:click.prevent="crear">
												Agregar Unidad
											</button>
										</div>
									</div>
									...
									<div class="row">
										<div class="col-md-3">
											<div class="input-group">
												...
												<input type="text" class="form-control apl-input-border apl-input-search" id="apl-table-buscar" placeholder="Buscar categoría" wire:model.debounce.800ms="search">
											</div>
										</div>
										...
										<div class="col-md-9">
											<div class="float-right">
												...
												<button type="button" class="btn btn-default btn-sm apl-btn-border" wire:click="eliminar()" {{$estaActivadoEliminar}}>
													Eliminar
												</button>
										...
										<table id="apl-table" class="table table-hover">
											...
											<tbody>
												...
												<tr class="apl-table-body-tr pointer">
													...
													<td wire:click="editar({{ $item->id}})">{{ $item->nombre }}</td>
													<td wire:click="editar({{ $item->id}})">{{ \Carbon\Carbon::parse($item->created_at)->format('d/m/Y H:m:s') }}</td>
						...
						<div class="row">
							...
							<div class="col-md-10 bg-white">
								<div class="modal-body">
									@livewire('invetario-inicial.formulario')
								</div>
							</div>
						</div>
					</div>
