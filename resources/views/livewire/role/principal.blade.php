							...
							<div class="card apl-border">
								<div class="card-header">
									<div class="row">
										<div class="col-md-6">
											<b>{{$data->count()}}</b><br>
											<font class="apl-text-gray">Roles</font>
										</div>

										<div class="col-md-6">
											<button title="Agregar unidad de medida" class="btn btn-primary float-right" style="border-radius: .7rem;" wire:click.prevent="crear">
									...
									<div class="row">
										<div class="col-md-3">
											<div class="input-group">
												...
												<input type="text" class="form-control apl-input-border apl-input-search" id="apl-table-buscar" placeholder="Buscar por rol" wire:model.debounce.800ms="search">
											</div>
										</div>
										...
										<table id="apl-table" class="table table-hover">
											...
											<tbody>
												...
												<tr class="apl-table-body-tr pointer">
													...
													<td wire:click="editar({{ $item->id}})">{{ $item->name }}</td>
													...
													<td>
														<a href="{{route('permission-asign',$item->id)}}" title="Agregar unidad de medida " class="btn btn-primary  mr-4" style="border-radius: .7rem;" >
															Asignar permisos
														</a>
														<a href="{{route('role-module-asign',$item->id)}}" title="Agregar unidad de medida" class="btn btn-primary " style="border-radius: .7rem;" >
															Asignar modulos
														</a>
