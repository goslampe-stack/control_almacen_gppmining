<div class="content-wrapper">
    <section class="content mt-3">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <h4 class="mb-3"><b>Requerimiento de compras</b></h4>
                </div>
            </div>
                            ...
                            <div class="card apl-border">
                                <div class="card-header">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <b>{{$data->count()}}</b><br>
                                            <font class="apl-text-gray">Requerimiento de compras</font>
                                        </div>

                                        <div class="col-md-6">
                                            @if(\App\Models\Util::checkPermission('orden-compra-create'))

                                            <button type="button" title="Agregar nueva requerimiento de compras" class="btn btn-primary float-right " style="border-radius: .7rem;" wire:click.prevent="crear">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-5">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control apl-input-border apl-input-search" id="apl-table-buscar" placeholder="Buscar por Nª de requerimiento de compras" wire:model.debounce.800ms="search">
                                        ...
                                        <table id="apl-table" class="table table-hover">
                                            <thead>
                                                <tr class="apl-table-header-tr">
                                                    <!--<td class="d-none"></td>-->
                                                    <td width="3%"></td>
                                                    <td  class="text-center">N° de requerimiento interno de productos</td>
                                                    <td class="text-center"> N° de requerimiento de compras</td>
                                                    <td  class="text-center">Fecha Requerimiento</td>
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="apl-table-body-tr pointer">
                                                    ...
                                                    <td class="text-center">{{ $item->requerimientoPersonal->numero_requerimiento }}</td>
                                                    <td class="text-center">{{ $item->numero_requerimiento_compra }}</td>
                                                    <td class="text-center"> {{\Carbon\Carbon::parse($item->fecha_requerimiento)->format('d-m-Y')}} </td>
                                                    ...
                                                    <td class="text-center"><button type="button" title="Editar" class="text-primary" wire:click="editar_RP({{$item->id}})">
                                                        ...
                                                        <a href="{{url('imprimir-requerimiento-compras',['mes'=>$item->id])}}" target="_blank" class="text-secondary" title="Imprimir"><i class="fas fa fa-print"></i></a>
            ...
            <div class="modal fade" id="modalForm" data-backdrop="static">
                <div class="modal-dialog modal-xl">
                    <div class="modal-content">
                        ...
                        @livewire('requerimiento-compras.formulario')
