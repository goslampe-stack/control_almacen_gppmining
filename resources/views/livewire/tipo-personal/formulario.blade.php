<div>
	...
	<div class="apl-mdl-formulario " id="apl-mdl-formulario">
		...
		<div class="row">
			<div class="col-md-12">
				<p><b>Proporciona información básica del tipo de personal</b><br><span>Información del tipo de personal.</span></p>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-6">
				<div class="form-group">
					...
					<span class="small">Agregue nombre del tipo de personal (Log&iacute;stica, Jefe mina) </span>
					<input type="text" class="form-control apl-input-border" wire:model="nombre">
