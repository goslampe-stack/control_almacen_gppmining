                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control apl-input-border apl-input-search" id="apl-table-buscar" placeholder="Buscar por número de salida " wire:model.debounce.800ms="search">
                                            </div>
                                        </div>
                                        ...
                                        <table id="apl-table" class="table table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="apl-table-body-tr pointer">
                                                    ...
                                                    <td>{{\Carbon\Carbon::parse($item->fecha_salida)->format('d-m-Y')}} {{ \Carbon\Carbon::parse($item->fecha_salida)->format('g:i A') }}</td>
                                                    <td>
                                                        @if($item->estado == 1)
                                                        Activo
                                                        @else
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        <a href="{{url('imprimir-salida',['mes'=>$item->id])}}" target="_blank" class="text-secondary" title="Imprimir art&iacute;culos agregados a orden de compra"><i class="fas fa fa-print"></i></a>
                                                    ...
                                                    <td>{{ $item->numero_salida }}</td>
                                                    <td>{{ $item->personal->apellidos }}, {{ $item->personal->nombre }}</td>
