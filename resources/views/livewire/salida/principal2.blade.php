<div class="content-wrapper">
    <section class="content mt-3">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <h4 class="mb-3"><b>Todos los requerimientos del personal</b></h4>
                </div>
            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="float-right">
                                                ...
                                                <button type="button" title="Eliminar" class="btn btn-default btn-sm apl-btn-border " wire:click="eliminar()" {{$estaActivadoEliminar}}>
                                        ...
                                        <table id="apl-table" class="table table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="apl-table-body-tr pointer">
                                                    ...
                                                    <td wire:click="editar_RP({{ $item->id}})">{{ $item->numero_requerimiento }}</td>
                                                    <td wire:click="editar_RP({{ $item->id}})"> {{ \Carbon\Carbon::parse($item->fecha_pedido)->format('d-m-Y') }}</td>
                                                    <td wire:click="editar_RP({{ $item->id}})">{{ $item->personal->apellidos }}, {{ $item->personal->nombre }}</td>
