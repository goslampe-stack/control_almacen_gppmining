<div class="content-wrapper">
	<section class="content mt-3">
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-12">
					<h4 class="mb-3"><b>Unidad de medida</b></h4>
				</div>
			</div>
							...
							<div class="card apl-border">
								<div class="card-header">
									<div class="row">
										<div class="col-md-6">
											<b>{{$data->count()}}</b><br>
											<font class="apl-text-gray">Unidades de medida</font>
										</div>
										...
										<div class="col-md-6">
											...
											<!-- <button title="Importar desde excel" class="btn btn-primary float-right mr-2 " style="border-radius: .7rem;" wire:click.prevent="importarExcel">
												<i class="fas fa-plus"></i> 
												Importar Excel
											</button> -->
						...
						<div class="row">
							...
							<div class="col-md-10 bg-white">
								<div class="modal-body">
									@livewire('tipo-unidad.formulario')
								</div>
							</div>
						</div>
					</div>
