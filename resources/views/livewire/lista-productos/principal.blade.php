                                        ...
                                        <table id="apl-table" class="table table-hover">
                                            <thead>
                                                <tr class="apl-table-header-tr">
                                                    ...
                                                    <td  class="text-center">Fecha creado</td>
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="apl-table-body-tr pointer">
                                                    ...
                                                    <td class="text-center"> {{\Carbon\Carbon::parse($item->created_at)->format('d-m-Y')}} {{ \Carbon\Carbon::parse($item->created_at)->format('g:i A') }}</td>
                                                    <td class="text-center"> {{\Carbon\Carbon::parse($item->fecha_pedido)->format('d-m-Y')}} {{ \Carbon\Carbon::parse($item->fecha_pedido)->format('g:i A') }}</td>
