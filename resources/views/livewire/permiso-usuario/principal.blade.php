<div class="content-wrapper">
	<section class="content mt-3">
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-12">
					<h4 class="mb-3"><b>Permisos usuario</b></h4>
				</div>
			</div>
							...
							<div class="card apl-border">
								<div class="card-header">
									<div class="row">
										...
										<div class="col-md-6">
											<!-- <button title="Agregar permiso" class="btn btn-primary float-right {{$permiso_agregar}}" style="border-radius: .7rem;" wire:click.prevent="crear">
											...
											<tbody>
												...
												<tr class="apl-table-body-tr pointer">
													...
													<td class="text-center">
														<button type="button" title="Ver permisos" class="text-primary" wire:click="editar({{$item->id}})">
						...
						<div class="row">
							...
							<div class="col-md-10 bg-white">
								<div class="modal-body">
									@livewire('permiso-usuario.formulario')
								</div>
							</div>
						</div>
					</div>
