<div class="content-wrapper">
    <section class="content mt-3">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <h4 class="mb-3"><b>Devoluciones</b></h4>
                </div>
            </div>
                            ...
                            <div class="card apl-border">
                                <div class="card-header">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <b>{{$data->count()}}</b><br>
                                            <font class="apl-text-gray">Devoluciones</font>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control apl-input-border apl-input-search" id="apl-table-buscar" placeholder="Buscar por articulo " wire:model.debounce.800ms="search">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-9">
                                            <div class="float-right">
                                               ...
                                               <!--  <button type="button" class="btn btn-default btn-sm apl-btn-border" {{$estaActivadorInactivo}} wire:click="abrirModalInactivar">
                                                    Desactivar
                                                </button>

                                                <button type="button" class="btn btn-default btn-sm apl-btn-border" {{$estaActivadorActivo}} wire:click="abrirModalActivar">
                                                    Activar
                                                </button> -->
                                        ...
                                        <table id="apl-table" class="table table-hover">
                                            <thead>
                                                <tr class="apl-table-header-tr">
                                                    ...
                                                    <td class="text-center">Tipo devoluci&oacute;n</td>
                                                    <td class="text-center">Comentario</td>
                                                    <td class="text-center">Fecha Devoluci&oacute;n</td>
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="apl-table-body-tr pointer">
                                                    ...
                                                    <td class="text-center">{{ $item->tipoDevolucion }}</td>
                                                    <td class="text-center">{{ $item->comentario }}</td>
                                                    <td class="text-center"> {{\Carbon\Carbon::parse($item->fecha_devolucion)->format('d-m-Y')}} {{ \Carbon\Carbon::parse($item->fecha_devolucion)->format('g:i A') }}</td>
            ...
            <div class="modal fade" id="modalForm" data-backdrop="static">
                <div class="modal-dialog modal-xl">
                    <div class="modal-content">
                        ...
                        @livewire('devolucion.formulario')
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row text-center">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <button class="btn btn-primary apl-btn-border ml-1" wire:click="inactivarOrdenCompras" wire:loading.attr="disabled">Inactivar</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal-content">
                        <div class="modal-body">
                            ...
                            <div class="row text-center">
                                ...
                                <div class="col-md-12">
                                    <button class="btn btn-default apl-btn-border mr-1" data-dismiss="modal">Cancelar</button>
                                    <button class="btn btn-primary apl-btn-border ml-1" wire:click="activarOrdenCompras" wire:loading.attr="disabled">Activar</button>
                                </div>
                            </div>
                        </div>
                    </div>
