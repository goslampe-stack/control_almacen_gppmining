<div class="content-wrapper">
	<section class="content mt-3">
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-12">
					<h4 class="mb-3"><b>Transportistas</b></h4>
				</div>
			</div>
							...
							<div class="card apl-border">
								<div class="card-header">
									<div class="row">
										<div class="col-md-6">
											<b>{{$data->count()}}</b><br>
											<font class="apl-text-gray">Transportistas</font>
										</div>

										<div class="col-md-6">
											<button class="btn btn-primary float-right {{$permiso_agregar}}" title="Agregar transportista" style="border-radius: .7rem;" wire:click.prevent="crear">
						...
						<div class="row">
							...
							<div class="col-md-10 bg-white">
								<div class="modal-body">
									@livewire('transporte.formulario')
								</div>
							</div>
						</div>
					</div>
						...
						<div class="modal-body">
							...
							<div class="row text-center">
								...
								<div class="col-md-12">
									...
									<button type="button" title="Inactivar" class="btn btn-primary apl-btn-border ml-1" wire:click="inactivarItemSeleccionados" wire:loading.attr="disabled">Inactivar</button>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="modal-content">
						<div class="modal-body">
							...
							<div class="row text-center">
								...
								<div class="col-md-12">
									<button type="button" title="Cancelar" class="btn btn-default apl-btn-border mr-1" data-dismiss="modal">Cancelar</button>
									<button type="button" title="Activar" class="btn btn-primary apl-btn-border ml-1" wire:click="activarItemSeleccionado" wire:loading.attr="disabled">Activar</button>
								</div>
							</div>
						</div>
					</div>
