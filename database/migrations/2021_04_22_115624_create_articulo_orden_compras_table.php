...
class CreateArticuloOrdenComprasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('articulo_orden_compras', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->integer('articulo_s_cotizacion_id')->nullable()->unsigned();
            $table->foreign('articulo_s_cotizacion_id')->references('id')->on('articulo_solicitud_cotizacions')->onUpdate('cascade')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('articulo_orden_compras');
    }
}
